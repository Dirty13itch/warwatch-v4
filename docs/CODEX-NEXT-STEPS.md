...
3. Extend the new operator synthesis lane into merge quality, persisted canonical write paths, and stronger structured extraction so the graph upgrades cleanly from live evidence.
