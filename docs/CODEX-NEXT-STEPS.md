...
2. Replace stale seeded top-line metrics with live ingestion or operator-reviewed refresh paths for market, strikes, throughput, and casualty indicators
...
- review-SLA reporting and queue aging visibility inside the operator lane
