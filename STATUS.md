...
- Preview proof now also writes `reports/previews/DIFF-LATEST.md` and `DIFF-LATEST.json`, which makes local-versus-live capture drift and public-truth parity reviewable without manually opening both atlas folders
